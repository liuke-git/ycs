        ...
        <form class="layui-form layui-form-pane" action="">
            ...
            <table style="border-collapse:separate; border-spacing:30px 25px;">
                    ...
                    <td>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="sysuser_userid" name="sysuserCustom.userid" value="${sysuserCustom.userid}" required
                ...
                <tr>
                    <td>
                        <div class="layui-form-item">
                        	 <span style="color:red">如果要修改密码请在此输入</span><br/>
                ...
                <tr>
                    <td>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="sysuserCustom_sysmc" name="sysuserCustom.sysmc" value="${sysuserCustom.sysmc}" required
                    ...
                    <td>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" >
                            	 <input type="radio" lay-verify="state" name="sysuserCustom.userstate" value="1"  <c:if test="${sysuserCustom.userstate=='1'}">checked</c:if> title="正常"/>
                                 <input type="radio" lay-verify="state" name="sysuserCustom.userstate" value="0"  <c:if test="${sysuserCustom.userstate=='0'}">checked</c:if> title="暂停"/>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="layui-form-item">
                            <button type="button" class="layui-btn" lay-submit="" lay-filter="submitform"
                                style="float:right;"><i class="layui-icon">&#xe642;</i>修改</button>
                        </div>
                    </td>
                    <td>
                        <div class="layui-form-item">
...
layui.use(['layer', 'form', 'element'], function () {
    ...
    form.on('submit(submitform)', function(data){
    	$.ajax({
    		  type: 'POST',
    		  url: "${pageContext.request.contextPath }/user/editSysusersubmit.action",
    		  data: data.field,
